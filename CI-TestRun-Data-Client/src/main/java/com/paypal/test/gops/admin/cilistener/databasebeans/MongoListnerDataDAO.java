...
import com.mongodb.client.model.UpdateOptions;
	...
	public class MongoListnerDataDAO implements ListnerDataDAO {
		...
		public final MongoClient client = new MongoClient(new ServerAddress("10.244.180.225", 27017),
				options);
		...
		public MongoListnerDataDAO(String collectionName) {
		...
		@Override
		public synchronized void writeIntoDb(Document doc, String ClassName){
			log.debug(doc);
